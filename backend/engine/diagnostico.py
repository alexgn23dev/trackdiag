    ...
    resultado = {
        ...
        "datos_audio": {
            ...
            "loudness": {
                ...
                "true_peak_ground_truth_validation_passed": senales["loudness"].get("true_peak_ground_truth_validation_passed", False),
                ...
                "recorte_medible": senales["loudness"].get("recorte_medible", False),
                "categoria_recorte": senales["loudness"].get("categoria_recorte", ""),
                "severidad_recorte": senales["loudness"].get("severidad_recorte", ""),
                "titulo_recorte": senales["loudness"].get("titulo_recorte", ""),
                "aviso_recorte": senales["loudness"].get("aviso_recorte", ""),
                "muestras_en_techo_total": senales["loudness"].get("muestras_en_techo_total", 0),
                "muestras_en_techo_por_canal": senales["loudness"].get("muestras_en_techo_por_canal", []),
                "pct_muestras_en_techo": senales["loudness"].get("pct_muestras_en_techo", 0.0),
                "racha_maxima_muestras": senales["loudness"].get("racha_maxima_muestras", 0),
                "racha_maxima_ms": senales["loudness"].get("racha_maxima_ms", 0.0),
                "n_mesetas": senales["loudness"].get("n_mesetas", 0),
                "canal_afectado": senales["loudness"].get("canal_afectado", ""),
                "concentracion_en_transitorios": senales["loudness"].get("concentracion_en_transitorios"),
                "posicion_maximo_seg": senales["loudness"].get("posicion_maximo_seg", 0.0),
                "true_peak_at_file_edge": senales["loudness"].get("true_peak_at_file_edge", False),
